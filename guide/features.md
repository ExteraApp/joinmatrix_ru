...
<div class="flash flash-warn"><ul>
  <li>Если сообщение было изменено, <b>все</b> изменения и оригинальное сообщение должны быть удалены, чтобы удалить сообщение!</li>
  <li>Если есть ответы на сообщение, то все ответы вместе с оригинальным сообщением должны быть удалены, чтобы полностью удалить содержимое сообщения. <b>С недавних пор, ответы удалять необязательно.</b></li>
